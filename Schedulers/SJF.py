...
class SJF:
    ...
    def printData(self, process_data, average_turnaround_time, average_waiting_time):
        ...
        for i in range(len(process_data)):
            sql = f"insert into sjf(process_id,arrival,burst,completed,completion,turnaround,wait) values ('{process_data[i][0]}','{process_data[i][1]}','{process_data[i][2]}','{process_data[i][3]}','{process_data[i][4]}','{process_data[i][5]}','{process_data[i][6]}')"
