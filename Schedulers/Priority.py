...
class Priority:
    ...
    def schedulingProcess(self, process_data):
        ...
        Priority.display(self, process_data, t_time, w_time, sequence_of_process)
    ...
    def display(self, process_data, average_turnaround_time, average_waiting_time, sequence_of_process):
        ...
        for i in range(len(process_data)):
            sql = f"insert into priority(process_id,arrival,priority,origin_burst,completion,turnaround) values ('{process_data[i][0]}','{process_data[i][1]}','{process_data[i][3]}','{process_data[i][5]}','{process_data[i][6]}','{process_data[i][7]}')"
